  ...
  **/
  getV1TaxLiabilities(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.GetV1TaxLiabilitiesResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  putV1TaxLiabilities(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PutV1TaxLiabilitiesResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.taxLiabilitiesSelections = httpRes?.data;
  ...
  **/
  putV1TaxLiabilitiesFinish(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PutV1TaxLiabilitiesFinishResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
