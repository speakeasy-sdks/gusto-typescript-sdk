...
export class Payrolls {
  ...
  **/
  getV1CompaniesCompanyIdPayrollReversals(
    ...
    const url: string = utils.generateURL(baseURL, "/v1/companies/{company_id}/payroll_reversals", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.GetV1CompaniesCompanyIdPayrollReversalsResponse = {statusCode: httpRes.status, contentType: contentType, rawResponse: httpRes};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.payrollReversal = plainToInstance(
                shared.PayrollReversal,
                httpRes?.data as shared.PayrollReversal,
  ...
  **/
  getV1CompaniesCompanyIdPayrolls(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/companies/{company_id}/payrolls", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetV1CompaniesCompanyIdPayrollsResponse = {statusCode: httpRes.status, contentType: contentType, rawResponse: httpRes};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.payrolls = httpRes?.data;
            }
            break;
          case httpRes?.status == 404:
            break;
  ...
  **/
  getV1CompaniesCompanyIdPayrollsPayrollId(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/companies/{company_id}/payrolls/{payroll_id}", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetV1CompaniesCompanyIdPayrollsPayrollIdResponse = {statusCode: httpRes.status, contentType: contentType, rawResponse: httpRes};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.payroll = plainToInstance(
                shared.Payroll,
                httpRes?.data as shared.Payroll,
                { excludeExtraneousValues: true }
              );
            }
            break;
  ...
  **/
  getV1CompaniesPayrollBlockersCompanyUuid(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/companies/{company_uuid}/payrolls/blockers", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetV1CompaniesPayrollBlockersCompanyUuidResponse = {statusCode: httpRes.status, contentType: contentType, rawResponse: httpRes};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.payrollBlockers = httpRes?.data;
            }
            break;
          case httpRes?.status == 404:
            break;
  ...
  **/
  getV1PaymentReceiptsPayrollsPayrollUuid(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/payrolls/{payroll_uuid}/receipt", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetV1PaymentReceiptsPayrollsPayrollUuidResponse = {statusCode: httpRes.status, contentType: contentType, rawResponse: httpRes};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.payrollReceipt = plainToInstance(
                shared.PayrollReceipt,
                httpRes?.data as shared.PayrollReceipt,
                { excludeExtraneousValues: true }
              );
            }
            break;
  ...
  **/
  getV1PayrollsPayrollUuidEmployeesEmployeeUuidPayStub(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/payrolls/{payroll_id}/employees/{employee_id}/pay_stub", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetV1PayrollsPayrollUuidEmployeesEmployeeUuidPayStubResponse = {statusCode: httpRes.status, contentType: contentType, rawResponse: httpRes};
        switch (true) {
          case httpRes?.status == 200:
            break;
          case httpRes?.status == 404:
  ...
  **/
  postV1CompaniesCompanyIdPayrolls(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostV1CompaniesCompanyIdPayrollsResponse = {statusCode: httpRes.status, contentType: contentType, rawResponse: httpRes};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.payroll = plainToInstance(
  ...
  **/
  postV1PayrollsPayrollUuidGeneratedDocumentsPrintablePayrollChecks(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PostV1PayrollsPayrollUuidGeneratedDocumentsPrintablePayrollChecksRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/payrolls/{payroll_id}/generated_documents/printable_payroll_checks", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostV1PayrollsPayrollUuidGeneratedDocumentsPrintablePayrollChecksResponse = {statusCode: httpRes.status, contentType: contentType, rawResponse: httpRes};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.payrollCheck = plainToInstance(
                shared.PayrollCheck,
                httpRes?.data as shared.PayrollCheck,
                { excludeExtraneousValues: true }
              );
            }
            break;
  ...
  **/
  putApiV1CompaniesCompanyIdPayrollsPayrollIdCancel(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/companies/{company_id}/payrolls/{payroll_id}/cancel", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancelResponse = {statusCode: httpRes.status, contentType: contentType, rawResponse: httpRes};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.payroll = plainToInstance(
  ...
  **/
  putV1CompaniesCompanyIdPayrolls(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PutV1CompaniesCompanyIdPayrollsResponse = {statusCode: httpRes.status, contentType: contentType, rawResponse: httpRes};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.payroll = plainToInstance(
  ...
  **/
  putV1CompaniesCompanyIdPayrollsPayPeriodStartDatePayPeriodEndDate(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PutV1CompaniesCompanyIdPayrollsPayPeriodStartDatePayPeriodEndDateRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/companies/{company_id}/payrolls/{pay_period_start_date}/{pay_period_end_date}", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PutV1CompaniesCompanyIdPayrollsPayPeriodStartDatePayPeriodEndDateResponse = {statusCode: httpRes.status, contentType: contentType, rawResponse: httpRes};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.payroll = plainToInstance(
  ...
  **/
  putV1CompaniesCompanyIdPayrollsPayrollIdCalculate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/companies/{company_id}/payrolls/{payroll_id}/calculate", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateResponse = {statusCode: httpRes.status, contentType: contentType, rawResponse: httpRes};
        switch (true) {
          ...
          case httpRes?.status == 422:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.putV1CompaniesCompanyIdPayrollsPayrollIdCalculate422ApplicationJSONOneOf = httpRes?.data;
            }
            break;
        }
  ...
  **/
  putV1CompaniesCompanyIdPayrollsPayrollIdSubmit(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/companies/{company_id}/payrolls/{payroll_id}/submit", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PutV1CompaniesCompanyIdPayrollsPayrollIdSubmitResponse = {statusCode: httpRes.status, contentType: contentType, rawResponse: httpRes};
        switch (true) {
          case httpRes?.status == 202:
            break;
          case httpRes?.status == 404:
          ...
          case httpRes?.status == 422:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.putV1CompaniesCompanyIdPayrollsPayrollIdSubmit422ApplicationJSONOneOf = httpRes?.data;
            }
            break;
        }
