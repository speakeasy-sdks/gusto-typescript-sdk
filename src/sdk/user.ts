  ...
  **/
  getV1Me(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.GetV1MeResponse = {statusCode: httpRes.status, contentType: contentType, rawResponse: httpRes,};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.currentUser = plainToInstance(
                shared.CurrentUser,
                httpRes?.data as shared.CurrentUser,
